		 ...
		 setContentView(R.layout.museum_layout);
		  ...
		  startSQL(); 
		        ...
		        Cursor cur1=db.rawQuery("SELECT Tab1,Tab2,Tab3 FROM Language WHERE language_id='"+ languageid+"'" ,null );
				  ...
				  tab1.setPadding(35, 8, 5, 5);
				  tab2.setPadding(25, 8, 5, 5);
				  tab3.setPadding(34, 8, 5, 5);
...
//			      startActivity(myIntent);
			     ...
			     mTabHst.addTab(mTabHst.newTabSpec("tab_test2").setIndicator(tab2).setContent(exhibiton));
			     mTabHst.addTab(mTabHst.newTabSpec("tab_test3").setIndicator(tab3).setContent(event));	    
